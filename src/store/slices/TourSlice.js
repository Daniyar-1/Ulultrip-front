...
export const categoryAction = createAsyncThunk(
 ...
 export const horseTourAction = createAsyncThunk(
    ...
    async (param, {dispatch, rejectWithValue}) => {
        try{
            const response = await axios('http://127.0.0.1:8000/api/v1/home/tours/?category=konnyj-tur')
            if(response.status === 200){
                const data = await response.data.results
                console.log(data);
...
export const peshijTurAction = createAsyncThunk(
    ...
    async (param, {dispatch, rejectWithValue}) => {
        try{
            const response = await axios('http://127.0.0.1:8000/api/v1/home/tours/?category=peshij-tur')
            if(response.status === 200) {
                const data = await response.data.results
                console.log(data)
 ...
 export const jeepsToursAction = createAsyncThunk(
    ...
    async (param, {dispatch, rejectWithValue}) => {
        try{
            const response = await axios ('http://127.0.0.1:8000/api/v1/home/tours/?category=jeep-tur')
            if(response.status === 200) {
                const data = await response.data.results
                console.log(data)
...
export const veloTutAction = createAsyncThunk(
    ...
    async (param, {dispatch, rejectWithValue}) => {
        try{
            const reponse = await axios('http://127.0.0.1:8000/api/v1/home/tours/?category=velotur')
